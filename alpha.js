/**----------( Created By RIZKI BOTz )----------
--------------------------------------------------------------------------
    ------------------------------------
@Rizki636 ( CREATOR )
-------------------------------------------------------
✓ RIZKI BOT ( RECODE ) : 
https://youtube.com/c/RizkiRidhoPratamaYT
-------------------------------------------------------
» Help Me 1k Subs Rizki Ridho Pratama
--------------------------------------------------------------**/
...
const { jytprem } = require('./menubot/ytprem')
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© RIZKI BOT Whatsapp_*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6287840411119-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `RIZKI BOT Whatsapp`, "footerText": "*_© RIZKI BOT Whatsapp_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "6287840411119-1616169743@g.us",
...
"key": {
	  "participant": `0@s.whatsapp.net`,
      "remoteJid": "6287840411119-1613049930@g.us",
      "fromMe": false,
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© RIZKI BOT Whatsapp_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
        ...
        const sendWebp = async(from, url) => {
	        ...
	        const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + `ORG:Developer RIZKI BOT Whatsapp\n` + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*RIZKI BOT*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
{buttonId:`owner`, buttonText: {displayText: '🛐OWNER BOT🛐'}, type: 1},{buttonId:`ytprem`, buttonText: {displayText: '🎟BELI YOUTUBE PREMIUM🎟️'}, type: 1}
]
const menuuu = {
    contentText: `${stamtus}`,
...
buttons = [
{buttonId:`owner`, buttonText: {displayText: '🛐OWNER BOT🛐'}, type: 1}, {buttonId:`listdonasi`, buttonText: {displayText: '📥DONASI️📥'}, type: 1}, {buttonId:`menu`, buttonText: {displayText: '🔝MAIN MENU🔝'}, type: 1}]
const allmenu = {
    contentText: `${stamtus}`,
...
{buttonId:`listdonasi`,buttonText:{displayText:'💗DONASI💗'},type:1}
]
...
case 'listdonasi':
 ...
 stod = `${sender}`
 listMsg = {
 buttonText: 'LIST METODE DONASI',
 description: `_*Hai Kak Silahkan Dipilih Metode Donasi Nya :)*_`,
 sections: [
                     {
...
────────────────────`
buttons = [
{buttonId:`allmenu`, buttonText: {displayText: '✅LIST MENU✅️'}, type: 1},
{buttonId:`owner`, buttonText: {displayText: '🛐OWNER BOT🛐'}, type: 1}, {buttonId:`menu`, buttonText: {displayText: '🔝MAIN MENU🔝'}, type: 1}]
case 'ytprem':

stamtus =`━━֍  〔 🪀 _*BY ${botName}*_ 🪀〕
──────────────────
◈ _Nama Owner : ${NamaOwner}_
◈ _Nomor Owner : ${NomorOwner}_
────────────────────
━━֍〔 🪀 *JUAL YOUTUBE PREMIUM*🪀〕
────────────────────
◈ YouTube Premium 1 Bulan = 1k(akun kamu)
◈ YouTube Premium 1 Bulan = 2k(akun admin)
◈ YouTube Premium 4 Bulan = 3k(akun kamu)
◈ YouTube Premium 4 Bulan = 4k(akun admin)
────────────────────
Minat Hubungi http://wa.me/6281256038434
────────────────────
`
buttons = [
{buttonId:`allmenu`, buttonText: {displayText: '✅LIST MENU✅️'}, type: 1},
...
//LUPA
       case 'maker3d': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
                    if (args.length < 1) return reply(`*Example :*\n${prefix + command} RIZKI BOT Whatsapp`)
					teksnya = args.join(" ")
					sticWait(from)
...
break
case 'SHOPEE-PAY'
SHOPEE-PAY =`SHOPEE PAY : ${shopeepay}`
break
case 'LINK-AJA'
LINK-AJA =`LINK AJA : ${linkaja}`
break
case 'donasi':
donasi =`╭─────────────────
│     ❒ *DONASI BOT* ❒
...
└─────────────────`
buttons = [
{buttonId:`allmenu`, buttonText: {displayText: '💟ALL MENU💟️'}, type: 1},
{buttonId:`owner`, buttonText: {displayText: '🗣️OWNER BOT🗣️'}, type: 1}, {buttonId:`menu`, buttonText: {displayText: '🔝MAIN MENU🔝'}, type: 1}]
const donatt = {
    contentText: `${donasi}`,
    buttons: buttons,
    headerType: 1
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `RIZKI BOT Whatsapp`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script RIZKI BOT Whatsapp`,
          "url": "https://github.com/Rizki636"
        },
        "index": 0
      }
    ]
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`RIZKI BOT Whatsapp`}, MessageType.location)
...
break
            ...
            break
				case 'attp':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
					if (!c) return reply(`Teks Nya Mana Kak?\nContoh :\n${prefix}attp RIZKI BOT Whatsapp`)
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY RIZKI BOT Whatsapp`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `RIZKI BOT Whatsapp`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `RIZKI BOT Whatsapp`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
...
const btngrass = {
    contentText: `${anu}`,
    footerText: '*RIZKI BOT Whatsapp_*',
    buttons: punten,
    headerType: 1
}
